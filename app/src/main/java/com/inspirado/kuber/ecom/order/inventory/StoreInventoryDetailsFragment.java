...
public class StoreInventoryDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_ecom_order_inventory_details, container, false);
    }
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    inventory.setOrgChain("/"+clientCode+"/"+user.getId());
                    inventory.setStatus(1);
                    Gson gson = new Gson();
                    JSONObject postData = new JSONObject(gson.toJson(inventory));
                    jsonObjectRequest = new JsonObjectRequest(method, getString(R.string.columbus_ms_url) +"/100/"+clientCode+"/inventories/orgs/"+ user.getId(), postData,
