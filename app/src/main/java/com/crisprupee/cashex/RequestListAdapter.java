...
//import com.crisprupee.cashex.tracking.MapsActivity;
//import com.crisprupee.cashex.tracking.ReplayActivity;
   ...
   public RequestListAdapter(Context context, ArrayList Requests) {
    ...
    public void onBindViewHolder(final RequestHolder holder, int position) {
       if(cashRequests!=null) {
           ...
           holder.mRequestDateView.setText( (new SimpleDateFormat("dd-MMM-yyyy HH:mm")).format(((CashRequest) cashRequests.get(position)).getRequestDate()));
